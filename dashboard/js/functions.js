const farmABI = [
	...
	},
	{
		...
		"name": "setImpermanentLossInsurance",
		"outputs": [
			{
				"internalType": "bool",
				"name": "",
	...
	},
	{
		"inputs": [
			{
				"internalType": "contract PolyDefy",
				"name": "_pfy",
				"type": "address"
			},
			{
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "contract ImpermanentLossInsurance",
				"name": "",
				"type": "address"
			}
		],
...
//
const apeAddress = "0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff"
let apeContract = undefined

const defyBnbApeAddress = "0x496C58731B583a5c3f0cE6c40299aDa000E5e4f1"
let defyBnbApeAuto = undefined

const defyBusdApeAddress = "0xEa467E73a53B813da9cD2F63969CDf15966DCba8"
let defyBusdApeAuto = undefined

const network = 'https://rpc-mainnet.matic.network'

const defy = '0xc35545B3c483075CAE6E0D94697a905dc5c52627'
let defyContract = undefined

const ilp = '0xc6C262252E33D0CC3aDD1A33ad7ddCEE375f0064'
let ilpContract = undefined

const wbnb = '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270'
let wbnbContract = undefined

const busd = '0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174'
let busdContract = undefined

const farmAddress = "0x7b86cFcA01dc73340E65eBc78461a13aD9477AFd"
let farmContract = undefined


var pools = []
//ApeSwap Pools		
pools.push( { name: 'APE-DEFY-BNB', addr: "0x496C58731B583a5c3f0cE6c40299aDa000E5e4f1", ilp: false,
...
pools.push( { name: 'APE-DEFY-BUSD', addr: "0xEa467E73a53B813da9cD2F63969CDf15966DCba8", ilp: true,
...
async function pendingDefy(pid){
	let pendingDefy = (parseInt(await farmContract.methods.pendingpfy(pid, user.address).call()) / 1e18)
	user.harvestable += pendingDefy
	$('.harvestable')[0].innerHTML = user.harvestable.toFixed(6)
	$('.pending-defy-'+pid)[0].innerHTML = " " +pendingDefy.toFixed(8)
}
